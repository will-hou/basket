...
const ItemCard = (props) => {
  ...
  return (
    <div
      ...
      className="p-3 cursor-pointer min-h-[200px] gap-3 border-black border-2 rounded-[20px] flex flex-row justify-center items-center max-w-[95vw] shadow-lg"
    >
      <img
      ...
      <div className="flex flex-col gap-2">
        <h2 className="font-display justify-start font-bold text-[24px]">
          {props.itemName}
        </h2>
